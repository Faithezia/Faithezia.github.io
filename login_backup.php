...
<div class="container">
  <div class="form-row">
  <h1 style="letter-spacing: 10px; text-align: center;">LOGIN FORM</h1>
    <div class="col-md-12 mb-3">
     ...
     <div class="invalid-feedback">
       ...
       <a href=""><button class="btn btn-primary" type="submit" name="submit">Login</button></a>
  </div>
  </form>
...
<?php
        ...
        if(isset($_POST['submit'])) {
          $query = mysqli_query($db, "SELECT * FROM `user` WHERE username='$_POST[username]'");
          $row = mysqli_fetch_row($query);
          $username_input = $_POST['username'];
          if($row == TRUE){
          $verify_query = mysqli_query($db, "SELECT * FROM `user` WHERE username='$_POST[username]'");
